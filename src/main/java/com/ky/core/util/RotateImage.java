...
public class RotateImage {
    ...
    public static void main (String[] args) {
        try {
            ...
            ImageIO.write(des1, "png", new File("d:/tmp/cc.png"));
//            ImageIO.write(des2, "png", new File("d:/tmp/bb.png"));
//            ImageIO.write(des3, "png", new File("d:/tmp/cc.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
